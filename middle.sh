...
while test "${PROMPT}" != 'q' ; do
	echo
	echo What to write to in_pipe_1?
	echo \(press "enter" to skip\)
	read TOPIPE
	printf "${TOPIPE}" > ${INPUT1}
	echo
...
#	Peek:
	...
	echo or \"enter\" to see how many bytes
	echo have been written to in_pipe_1
	echo
	read -n 1 PROMPT
done
...
# printf '1' > ${I1_PAUSE}
cat ${IN_BYTE}
# For some reason, running the following line in foreground causes a
#	./middle.sh: line 120: in_pause_2: Interrupted system call
# error:
printf '1' > ${I2_PAUSE} &
